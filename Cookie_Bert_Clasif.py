...
df_train = pd.read_csv(path/'train_cookie2.csv',header=0)
df_train.columns = [0, 2]#To reuse code that I did previously
df_test = pd.read_csv(path/'test_cookie2.csv',header=0)
df_test.columns = [0, 2]
print(df_train.head())
...
do_lower_case = True
train_file = "Text_for_finetuning.txt"
...
cache_dir = ''
Books_pretrained_weights = None#path / 'books_clasif.bin'
num_labels = 5
...
#model_state_dict = torch.load(Books_pretrained_weights) # Lo quito porque no tengo modelo del lenguaje
model = BertForSequenceClassification.from_pretrained(bert_model,
                                                      cache_dir=cache_dir, #state_dict = model_state_dict,#Lo quito porque no tengo modelo del lenguaje
